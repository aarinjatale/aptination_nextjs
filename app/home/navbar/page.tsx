  ...
  return (
    <div className="flex items-center gap-4 px-4 py-2 w-full justify-center to your outer" onClick={() => router.push("/")}>
      ...
      <div className="flex items-center bg-black rounded-full px-8 py-2 gap-6">
        ...
        {/* Login/SignUp Button */}
        <button
          className="text-white font-bold text-lg bg-transparent hover:bg-gray-800 px-6 py-2 rounded transition"
      ...
      {/* Try Premium Pill */}
      <button
        className="ml-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-black font-bold text-lg px-8 py-2 rounded-full shadow hover:from-yellow-500 hover:to-yellow-700 transition"
